...
## [Settings](https://github.com/vanhbakaa/PocketFi/blob/main/.env-example)
| Settings | Description |
|----------------------------|:-------------------------------------------------------------------------------------------------------------:|
| **API_ID / API_HASH**      | Platform data from which to run the Telegram session (default - android)                                      |
| **REF_LINK**               | auto register with your ref link (default: my ref link)                                                       |
| **ADVANCED_ANTI_DETECTION** | Reduce chance of being banned (default: False)                                                       |
...
## Installation
You can download the [**repository**](https://github.com/vanhbakaa/PocketFi) by cloning it to your system and installing the necessary dependencies:
```shell
git https://github.com/vanhbakaa/PocketFi.git
cd PocketFi
```
...
```shell
~/PocketFi >>> python3 main.py --action (1/2)
# Or
~/PocketFi >>> python3 main.py -a (1/2)
...
You can also use arguments for quick start, for example:
```shell
~/PocketFi >>> python main.py --action (1/2)
# Or
~/PocketFi >>> python main.py -a (1/2)
